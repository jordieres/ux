                ...
                if msg:
                    ...
                    if "VA" in sender_jid and res != None: # res => VA is the next
                        ...
                        if msgl.loc[0,'purpose'] == 'update':
                            ...
                            coil_df.at[0,'budget'] = agent_df.loc[0,'bdg']
                            coil_df.at[0,'loc'] = agent_df.loc[0,'From']
                            coil_df.at[0,'oname'] = agent_df.loc[0,'orden']
                            coil_df.at[0,'name'] = agent_df.loc[0,'code']
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sd', '--order_shdate', type=str, metavar='',required=False, default='1970-01-31', help='Specify the ship date of the order. Example: --sd "2021-11-01" ')
