...
import logging, argparse, globals,pdb
import numpy as np
import pandas as pd
    ...
    class NWWBehav(PeriodicBehaviour):
        async def run(self):
            global process_df, nww_status_var, my_full_name, nww_status_started_at, \
                   ...
                   lot_size, dim_df, auction_df, fab_started_at, leeway, op_times_df, \
                   auction_start, nww_to_tr_df, transport_needed, warehouse_needed
            nww_activation_json = opf.activation_df(my_full_name, nww_status_started_at, \
                                                    globals.gnww_jid)
            ...
            if nww_status_var == "pre-auction":
                ...
                nww_inform_json = opf.inform_log_df(my_full_name, 'nww',nww_status_started_at, nww_status_var).to_json()
